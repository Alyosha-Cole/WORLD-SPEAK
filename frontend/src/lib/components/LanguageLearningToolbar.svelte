<script>
  ...
  // Learning modes - removed linguist as it's now integrated into default
  const learningModes = [
...
<div class="language-learning-toolbar bg-gray-50 border-t border-gray-200">
  ...
  <!-- Note: Removed the linguist-specific toolbar since that functionality is now in the default mode -->
</div>
